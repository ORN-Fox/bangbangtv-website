<template>
    <BreadcrumbSite pageTitle="Nos rÃ©alisations"/>
...
<script lang="ts">
    ...
    export default defineComponent({
      ...
      setup() {
        ...
        const initBackgroundManagementAndMixitup = () => {
          setTimeout(() => {
        ...
        const loadMachinimas = () => {
          ...
          videos.splice(0, videos.length, ...[
            ...
            new Video('longMachinima', 'Halo 5 prend la relève', '5R2WpiZocA', ['Noël']),
        ...
        const loadVideos = (category: string) => {
          ...
          initBackgroundManagementAndMixitup();
          initMaginificPopup();
        };
        ...
        watch(
          ...
          (newCategory) => {
            ...
            loadVideos(newCategory as string);
          }
        );

        onMounted(() => {
          loadVideos(route.params.category as string);
        });
